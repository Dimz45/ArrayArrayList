...
public class Buku {
    ...
    private int tahunTerbit; // <-- TAMBAHAN UNTUK SOAL NO 2

    // Constructor: dipanggil saat objek dibuat
    public Buku(String judul, String penulis, int tahunTerbit) { // <-- MODIFIKASI CONSTRUCTOR
        this.judul = judul;
        this.penulis = penulis;
        this.tahunTerbit = tahunTerbit; // <-- TAMBAHAN
    ...
    public int getTahunTerbit() { // <-- TAMBAHAN GETTER
        return tahunTerbit;
    }
    ...
    public String info() {
        ...
        // <-- MODIFIKASI INFO UNTUK MENAMPILKAN TAHUN TERBIT
